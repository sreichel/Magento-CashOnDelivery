...
- Fixed "Add Create Invoice Option - Add ability to configure that a cash on delivery order automatically create an invoice." (Thanks to [Flipmediaco](https://github.com/Flipmediaco) (#19))
- "SR-714 allow capture offline" (Thanks to Pascal Querner)
- "add cod_fee, base_cod_fee attributes to webservices" (Thanks to [tawfekov](https://github.com/tawfekov) (#33))
